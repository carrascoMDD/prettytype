...
/// <reference path="src/dumpingpolicy/dumpingpolicy_ng_type.js"/>
"use strict";
...
var aTest_spec = (function( theSS_identifier_svce,
    ...
    describe( TestName, function () {
        ...
        if( ( typeof beforeEach === 'function') && ( typeof module === 'function')  && ( typeof inject === 'function')) {
            ...
            beforeEach( inject(function( _identifier_svce_, _dumpingpolicy_type_) {
        ...
        it("Module is defined", function () {
            expect( aM_dumpingpolicy_type).not.toBeUndefined();
        });
        
        
        it("Has module meta definitions", function () {
            expect( aM_dumpingpolicy_type._v_Kind).toBe( "module");
            expect( aM_dumpingpolicy_type.ComponentName).toBe( "prettytype");
            expect( aM_dumpingpolicy_type.ModuleName).toBe( "dumpingpolicy_type");
            expect( aM_dumpingpolicy_type.ModulePackages).toBe( "recording");
            expect( aM_dumpingpolicy_type.ModuleFullName).toBe( "recording/dumpingpolicy_type");
        });
            ...
            if( aGeneralFunctionName) {
                (function() {
                    ...
                    it("Module exposes general definition function " + aGeneralFunctionName_here, function () {
                        var aGeneralFunction = aM_dumpingpolicy_type[ aGeneralFunctionName_here];
            ...
            if( aSpecificFunctionName) {
                (function() {
                    ...
                    it("Module exposes specific definition function " + aSpecificFunctionName_here, function () {
                        var aSpecificFunction = aM_dumpingpolicy_type[ aSpecificFunctionName_here];
        ...
        var someConstantNames = [
            "MAYDUMPRECORDS",
            "DUMPINGPOLICY_DEFAULTTITLE",
            "RECORDPOINTERNAME_LASTDUMPED"
        ];
            ...
            if( aModuleConstantName) {
                (function() {
                    ...
                    it("Module exposes constant " + aModuleConstantName_here, function () {
                        var aModuleConstant = aM_dumpingpolicy_type[ aModuleConstantName_here];
            ...
            if( aPrototypeName) {
                (function() {
                    ...
                    it("Module exposes prototype object with name " + aPrototypeName_here, function () {
                        var anPrototype = aM_dumpingpolicy_type[ aPrototypeName_here];
        ...
        it("Has same prototype object under generic and specific names", function () {
            expect( aM_dumpingpolicy_type.Prototype).toBe( aM_dumpingpolicy_type.DumpingPolicy_Prototype);
        });
        
        
        
        it("Prototype has meta definitions", function () {
            var aPrototype = aM_dumpingpolicy_type.Prototype;
            
            expect( aPrototype._v_Kind).toBe( "prototype");
            expect( aPrototype._v_SuperPrototype).toBe( null);
            expect( aPrototype._v_Type).toBe( "DumpingPolicy");
            expect( aPrototype._v_Prototype_DumpingPolicy).toBe( aPrototype);
            expect( aPrototype._v_Module).toBe( aM_dumpingpolicy_type);
        });
            ...
            if( aInstanceSlotName) {
                (function() {
                    ...
                    it("Instance has slot with name " + aInstanceSlotName_here, function () {
                        var anInstance = new aM_dumpingpolicy_type.DumpingPolicy_Constructor(
...
if ( (typeof define === 'function') && define.amd) {
    // AMD / RequireJS
    define( "dumpingpolicy_type_structural_test",
        [
            "identifier_svce",
            "dumpingpolicy_type"
        ],
