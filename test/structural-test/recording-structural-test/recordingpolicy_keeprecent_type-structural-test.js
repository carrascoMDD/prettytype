...
var aTest_spec = (function( theSS_identifier_svce,
    ...
    var ModuleName     = "recordingpolicy_keeprecent_type-structural-test";
    ...
    describe( TestName, function () {
        ...
        if( ( typeof beforeEach === 'function') && ( typeof module === 'function')  && ( typeof inject === 'function')) {
            ...
            beforeEach( inject(function( _identifier_svce_, _recordingpolicy_keeprecent_type_) {
        ...
        it("Module is defined", function () {
            expect( aM_recordingpolicy_keeprecent_type).not.toBeUndefined();
        });
        
        
        it("Has module meta definitions", function () {
            expect( aM_recordingpolicy_keeprecent_type._v_Kind).toBe( "module");
            expect( aM_recordingpolicy_keeprecent_type.ComponentName).toBe( "prettytype");
            expect( aM_recordingpolicy_keeprecent_type.ModuleName).toBe( "recordingpolicy_keeprecent_type");
            expect( aM_recordingpolicy_keeprecent_type.ModulePackages).toBe( "recording");
            expect( aM_recordingpolicy_keeprecent_type.ModuleFullName).toBe( "recording/recordingpolicy_keeprecent_type");
        });
            ...
            if( aGeneralFunctionName) {
                (function() {
                    ...
                    it("Module exposes general definition function " + aGeneralFunctionName_here, function () {
                        var aGeneralFunction = aM_recordingpolicy_keeprecent_type[ aGeneralFunctionName_here];
        ...
        var someSpecificFunctionNames = [
            "RecordingPolicyKeepRecent_ProtoInstancer",
            "RecordingPolicyKeepRecent_ProtoDefinerOn",
            "RecordingPolicyKeepRecent_ProtoFactory",
            "RecordingPolicyKeepRecent_Constructor",
            "RecordingPolicyKeepRecent_SuperPrototypeConstructor",
            "RecordingPolicyKeepRecent_CreatePrototypeSlotsOn",
            "RecordingPolicyKeepRecent_CreateInstanceSlotsOn",
            ...
            if( aSpecificFunctionName) {
                (function() {
                    ...
                    it("Module exposes specific definition function " + aSpecificFunctionName_here, function () {
                        var aSpecificFunction = aM_recordingpolicy_keeprecent_type[ aSpecificFunctionName_here];
        ...
        var someConstantNames = [
            "MUSTKEEPRECORDSRECENTMILLIS",
            "RECORDINGPOLICYKEEPRECENT_DEFAULTTITLE"
        ];
            ...
            if( aModuleConstantName) {
                (function() {
                    ...
                    it("Module exposes constant " + aModuleConstantName_here, function () {
                        var aModuleConstant = aM_recordingpolicy_keeprecent_type[ aModuleConstantName_here];
        ...
        var somePrototypeNames = [
            "Prototype",
            "RecordingPolicyKeepRecent_Prototype"
        ];
            ...
            if( aPrototypeName) {
                (function() {
                    ...
                    it("Module exposes prototype object with name " + aPrototypeName_here, function () {
                        var anPrototype = aM_recordingpolicy_keeprecent_type[ aPrototypeName_here];
        ...
        it("Has same prototype object under generic and specific names", function () {
            expect( aM_recordingpolicy_keeprecent_type.Prototype).toBe( aM_recordingpolicy_keeprecent_type.RecordingPolicyKeepRecent_Prototype);
        });
        
        
        
        it("Prototype has meta definitions", function () {
            var aPrototype = aM_recordingpolicy_keeprecent_type.Prototype;
            expect( aPrototype._v_Kind).toBe( "prototype");
            expect( aPrototype._v_SuperPrototype).not.toBe( null);
            expect( aPrototype._v_Type).toBe( "RecordingPolicyKeepRecent");
            expect( aPrototype._v_Prototype_RecordingPolicyKeepRecent).toBe( aPrototype);
            expect( aPrototype._v_Prototype_RecordingPolicy).not.toBe( null);
            expect( aPrototype._v_Module).toBe( aM_recordingpolicy_keeprecent_type);
        });
        ...
        var somePrototypeSpecificFunctionNames = [
            "_pInit_RecordingPolicyKeepRecent",
            "pSetMustKeepRecords",
            "fMustKeepRecords",
            "fRecordRecord",
            "pPruneRecords"
            ...
            if( aInstanceSlotName) {
                (function() {
                    ...
                    it("Instance has slot with name " + aInstanceSlotName_here, function () {
                        var anInstance = new aM_recordingpolicy_keeprecent_type.RecordingPolicyKeepRecent_Constructor(
...
if ( (typeof define === 'function') && define.amd) {
    // AMD / RequireJS
    define( "recordingpolicy_keeprecent_type_structural_test",
        [
            "identifier_svce",
