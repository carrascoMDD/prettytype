...
var aTest_spec = (function( theSS_identifier_svce,
    ...
    describe( ModuleName + " " + ModulePackages + " " + ComponentName, function () {
        ...
        var aRecordingPolicyKeepRecent_title = "RecordingPolicyKeepRecent-Title-test";
        ...
        if( ( typeof beforeEach === 'function') && ( typeof module === 'function')  && ( typeof inject === 'function')) {
            ...
            beforeEach( inject(function( _IdentifierSvce_, _RecordingPolicyKeepRecentType_) {
                aM_identifier_svce      = _IdentifierSvce_;
                aM_recordingpolicy_keeprecent_type = _RecordingPolicyKeepRecentType_;
                aRecordingPolicyKeepRecent = new aM_recordingpolicy_keeprecent_type.RecordingPolicyKeepRecent_Constructor( aRecordingPolicyKeepRecent_title, aM_identifier_svce, null /* theRecorder its absence should not affect this structure test */);
            }));
        }
        ...
        var someFunctionNames = [
            ...
            "pSetMustKeepRecordsRecentMillis",
            ...
            if( aFunctionName) {
                (function() {
                    ...
                    it("Has function " + aFunctionName_here + " defined", function () {
                        var aFunction = aRecordingPolicyKeepRecent[ aFunctionName_here];
...
if ( (typeof define === 'function') && define.amd) {
    ...
    * If it is a variable, no test specs shall be registered (i.e., it does not invoke the test spec function */
    define( "m_recordingpolicy_keeprecent_type_structural_test",
        [
            "m_identifier_svce",
