...
requirejs.config({
     ...
     */
    paths: {
        'm_typesregistry_structural_test':                    './test/structural-test/typesregistry-structural-test/typesregistry-structural-test',
        'm_overrider_type_structural_test':                   './test/structural-test/overrider-structural-test/overrider_type-structural-test',
        'm_overrider_svce_structural_test':                   './test/structural-test/overrider-structural-test/overrider_svce-structural-test',
