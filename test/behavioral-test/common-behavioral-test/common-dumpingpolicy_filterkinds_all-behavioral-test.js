...
var aTest_spec = (function( theSS_identifier_svce,
    ...
    describe( ModuleName + " " + ModulePackages + " " + ComponentName, function () {
        ...
        var aMethodName = "common_dumpingpolicyfiterkindsall__theMethodName";
        var anEventKind = "common_dumpingpolicyfiterkindsall__theEventKind";
        var aData       = "common_dumpingpolicyfiterkindsall__theData";
        var aReason     = "common_dumpingpolicyfiterkindsall__theReason";
        var aDetail     = "common_dumpingpolicyfiterkindsall__theDetail";
        
        var aMethodName2 = "common_dumpingpolicyfiterkindsall__theMethodName2";
        var anEventKind2 = "common_dumpingpolicyfiterkindsall__theEventKind2";
        var aData2       = "common_dumpingpolicyfiterkindsall__theData2";
        var aReason2     = "common_dumpingpolicyfiterkindsall__theReason2";
        var aDetail2     = "common_dumpingpolicyfiterkindsall__theDetail2";
        ...
        it("Dumps two recorded Records", function () {
            ...
            aDumpingPolicyFilterKinds = new aM_dumpingpolicy_filterkinds_type.DumpingPolicyFilterKinds_Constructor( "DumpingPolicy-for-common_svce-dumpingpolicy_filterkinds_all-behavioral-test.js", aCommon_Identifier, aCommon_Recorder);
...
if ( (typeof define === 'function') && define.amd) {
    ...
    * If it is a variable, no test specs shall be registered (i.e., it does not invoke the test spec function */
    define( "m_common_dumpingpolicy_filterkinds_all_behavioral_test",
        [
            "m_identifier_svce",
            "m_recorder_type",
            "m_common_type",
