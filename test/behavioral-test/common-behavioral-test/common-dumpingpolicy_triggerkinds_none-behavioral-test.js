...
var aTest_spec = (function( theSS_identifier_svce,
    ...
    var ModuleName     = "common-dumpingpolicy_triggerkinds_none-behavioral-test";
    ...
    describe( ModuleName + " " + ModulePackages + " " + ComponentName, function () {
        ...
        var aMethodName = "common_dumpingpolicy_triggerkinds_none__theMethodName";
        var anEventKind = "common_dumpingpolicy_triggerkinds_none__theEventKind";
        var aData       = "common_dumpingpolicy_triggerkinds_none__theData";
        var aReason     = "common_dumpingpolicy_triggerkinds_none__theReason";
        var aDetail     = "common_dumpingpolicy_triggerkinds_none__theDetail";
    
        var aMethodName2 = "common_dumpingpolicy_triggerkinds_none__theMethodName2";
        var anEventKind2 = "common_dumpingpolicy_triggerkinds_none__theEventKind2";
        var aData2       = "common_dumpingpolicy_triggerkinds_none__theData2";
        var aReason2     = "common_dumpingpolicy_triggerkinds_none__theReason2";
        var aDetail2     = "common_dumpingpolicy_triggerkinds_none__theDetail2";
    
        var aMethodName3 = "common_dumpingpolicy_triggerkinds_none__theMethodName3";
        var anEventKind3 = "common_dumpingpolicy_triggerkinds_none__theEventKind3";
        var aData3       = "common_dumpingpolicy_triggerkinds_none__theData3";
        var aReason3     = "common_dumpingpolicy_triggerkinds_none__theReason3";
        var aDetail3     = "common_dumpingpolicy_triggerkinds_none__theDetail3";
...
if ( (typeof define === 'function') && define.amd) {
    ...
    * If it is a variable, no test specs shall be registered (i.e., it does not invoke the test spec function */
    define( "m_common_dumpingpolicy_triggerkinds_none_behavioral_test",
        [
            "m_identifier_svce",
            "m_recorder_type",
            "m_common_type",
