/*
 * common-recordingpolicy_keepall_donotkeep-behavioral-test.js
 *
...
var aTest_spec = (function( theSS_identifier_svce,
    ...
    var ModuleName     = "common-recordingpolicy_keepall_donotkeep-behavioral-test";
...
if ( (typeof define === 'function') && define.amd) {
    ...
    * If it is a variable, no test specs shall be registered (i.e., it does not invoke the test spec function */
    define( "m_common_recordingpolicy_keepall_donotkeep_behavioral_test",
        [
            "m_identifier_svce",
            "m_recorder_svce",
            "m_common_type",
