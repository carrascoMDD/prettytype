...
var aTest_spec = (function( theSS_identifier_svce,
    ...
    describe( ModuleName + " " + ModulePackages + " " + ComponentName, function () {
        ...
        if( ( typeof beforeEach === 'function') && ( typeof module === 'function')  && ( typeof inject === 'function')) {
            ...
            beforeEach( inject(function( _identifier_svce_, _recorder_type_, _common_type_, _recordingpolicy_keepall_type_, _dumpingpolicy_filterkinds_type_, _console_svce_) {
...
if ( (typeof define === 'function') && define.amd) {
    ...
    * If it is a variable, no test specs shall be registered (i.e., it does not invoke the test spec function */
    define( "common_dumpingpolicy_filterkinds_some_behavioral_test",
        [
            "identifier_svce",
            "recorder_type",
            "common_type",
