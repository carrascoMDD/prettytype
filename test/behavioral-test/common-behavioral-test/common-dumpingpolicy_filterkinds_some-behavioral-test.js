/*
 * common-dumpingpolicy_filterkinds_some-behavioral-test.js
 *
...
var aTest_spec = (function( theSS_identifier_svce,
    ...
    var ModuleName     = "common-dumpingpolicy_filterkinds_some-behavioral-test";
    ...
    describe( ModuleName + " " + ModulePackages + " " + ComponentName, function () {
        ...
        var aMethodName = "common_dumpingpolicy_fiterkinds_some__theMethodName";
        var anEventKind = "common_dumpingpolicy_fiterkinds_some__theEventKind";
        var aData       = "common_dumpingpolicy_fiterkinds_some__theData";
        var aReason     = "common_dumpingpolicy_fiterkinds_some__theReason";
        var aDetail     = "common_dumpingpolicy_fiterkinds_some__theDetail";
    
        var aMethodName2 = "common_dumpingpolicy_fiterkinds_some__theMethodName2";
        var anEventKind2 = "common_dumpingpolicy_fiterkinds_some__theEventKind2";
        var aData2       = "common_dumpingpolicy_fiterkinds_some__theData2";
        var aReason2     = "common_dumpingpolicy_fiterkinds_some__theReason2";
        var aDetail2     = "common_dumpingpolicy_fiterkinds_some__theDetail2";
        ...
        if( ( typeof beforeEach === 'function') && ( typeof module === 'function')  && ( typeof inject === 'function')) {
            ...
            beforeEach( inject(function( _IdentifierSvce_, _RecorderType_, _CommonType_, _DumpingPolicyFilterKindsType_, _ConsoleSvce_) {
        ...
        it("Dumps two recorded Records", function () {
            ...
            aDumpingPolicyFilterKinds = new aM_dumpingpolicy_filterkinds_type.DumpingPolicyFilterKinds_Constructor( "DumpingPolicy-for-common_svce-dumpingpolicy_filterkinds_some-behavioral-test.js", aCommon_Identifier, aCommon_Recorder);
...
if ( (typeof define === 'function') && define.amd) {
    ...
    * If it is a variable, no test specs shall be registered (i.e., it does not invoke the test spec function */
    define( "m_common_dumpingpolicy_filterkinds_some_behavioral_test",
        [
            "m_identifier_svce",
            "m_recorder_type",
            "m_common_type",
