/*
 * common_type-dumpingpolicy_filterkinds_all-behavioral-test.js
 *
 * Created @author Antonio Carrasco Valero 201610121801
 *
 *
 ***************************************************************************
...
describe("prettytype Common dumpingpolicy filterkinds all behavioral tests", function () {
    ...
    var someCollectedLogsAfter1 = aModule_ConsoleSvce.fCollectedLogs();
    ...
    var someCollectedLogsAfter2 = aModule_ConsoleSvce.fCollectedLogs();
