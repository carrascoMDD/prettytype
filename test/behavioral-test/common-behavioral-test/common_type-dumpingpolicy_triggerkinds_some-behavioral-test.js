/*
 * common_type-dumpingpolicy_triggerkinds_some-behavioral-test.js
 *
 * Created @author Antonio Carrasco Valero 201610281543
 *
 *
 ***************************************************************************
...
describe("prettytype Common dumpingpolicy triggerkinds some behavioral tests", function () {
    ...
    var aMethodName = "common_type_record_test_dumpingpolictriggerkindsall__theMethodName";
    var anEventKind = "common_type_record_test_dumpingpolictriggerkindsall__theEventKind";
    var aData       = "common_type_record_test_dumpingpolictriggerkindsall__theData";
    var aReason     = "common_type_record_test_dumpingpolictriggerkindsall__theReason";
    var aDetail     = "common_type_record_test_dumpingpolictriggerkindsall__theDetail";




    var aMethodName2 = "common_type_record_test_dumpingpolictriggerkindsall__theMethodName2";
    var anEventKind2 = "common_type_record_test_dumpingpolictriggerkindsall__theEventKind2";
    var aData2       = "common_type_record_test_dumpingpolictriggerkindsall__theData2";
    var aReason2     = "common_type_record_test_dumpingpolictriggerkindsall__theReason2";
    var aDetail2     = "common_type_record_test_dumpingpolictriggerkindsall__theDetail2";



    var aMethodName3 = "common_type_record_test_dumpingpolictriggerkindsall__theMethodName3";
    var anEventKind3 = "common_type_record_test_dumpingpolictriggerkindsall__theEventKind3";
    var aData3       = "common_type_record_test_dumpingpolictriggerkindsall__theData3";
    var aReason3     = "common_type_record_test_dumpingpolictriggerkindsall__theReason3";
    var aDetail3     = "common_type_record_test_dumpingpolictriggerkindsall__theDetail3";
    ...
    it("Has aLastCollectedLogAfter2 == aRecord", function () {

        var aLastCollectedLogAfter2 = someCollectedLogsAfter2[ 0];
        ...
        expect( aLastCollectedLogAfter2_message).toBe( "," + aRecord.fLogString());
    ...
    it("Has aCommon_Recorder_SetRecordingPointer_01_afterThirdRecord == -1", function () {
        expect( aCommon_Recorder_SetRecordingPointer_01_afterThirdRecord).toBe( -1);
    });


    it("Has aCommon_Recorder_SetRecordingPointer_02_afterThirdRecord == 0", function () {
        expect( aCommon_Recorder_SetRecordingPointer_02_afterThirdRecord).toBe( 0);
    });


    it("Has aCommon_Recorder_SetRecordingPointer_03_afterThirdRecord == 1", function () {
        expect( aCommon_Recorder_SetRecordingPointer_03_afterThirdRecord).toBe( 1);
    });

    it("Has aCommon_Recorder_SetRecordingPointer_04_afterThirdRecord == 2", function () {
