/*
 * common_type-recordingpolicy_keepall-donotkeep-behavioral-test.js
 *
...
describe("prettytype Common recordingpolicy keepAll doNotKeep behavioral tests", function () {
    ...
    var aMethodName = "common_type_record_test_recordingpolicykeepalldonotkeep__theMethodName";
    var anEventKind = "common_type_record_test_recordingpolicykeepalldonotkeep__theEventKind";
    var aData       = "common_type_record_test_recordingpolicykeepalldonotkeep__theData";
    var aReason     = "common_type_record_test_recordingpolicykeepalldonotkeep__theReason";
    var aDetail     = "common_type_record_test_recordingpolicykeepalldonotkeep__theDetail";


    var aMethodName2 = "common_type_record_test_recordingpolicykeepalldonotkeep__theMethodName2";
    var anEventKind2 = "common_type_record_test_recordingpolicykeepalldonotkeep__theEventKind2";
    var aData2       = "common_type_record_test_recordingpolicykeepalldonotkeep__theData2";
    var aReason2     = "common_type_record_test_recordingpolicykeepalldonotkeep__theReason2";
    var aDetail2     = "common_type_record_test_recordingpolicykeepalldonotkeep__theDetail2";
    ...
    var someKeptRecordsAfterClear = aCommon_Recorder.fKeptRecords();
    ...
    var aCommon_Recorder_RecordingPolicy = aCommon_Recorder.fRecordingPolicy();

    it("Has _v_Recorder.fRecordingPolicy() defined", function () {
        expect( aCommon_Recorder_RecordingPolicy).not.toBeUndefined();
    });

    it("Has _v_Recorder.fRecordingPolicy() typeof object", function () {
        expect( typeof aCommon_Recorder_RecordingPolicy).toBe( "object");
    });

    it("Has _v_Recorder.fRecordingPolicy() not null", function () {
        expect( aCommon_Recorder_RecordingPolicy).not.toBeNull();
    });
    ...
    it("Has aCommon_Recorder.fKeptRecords() defined", function () {
        expect( someKeptRecordsAfterClear).not.toBeUndefined();
    });

    it("Has aCommon_Recorder.fKeptRecords() typeof object", function () {
        expect( typeof someKeptRecordsAfterClear).toBe( "object");
    });

    it("Has aCommon_Recorder.fKeptRecords() not null", function () {
        expect( someKeptRecordsAfterClear).not.toBeNull();
    });

    it("Has aCommon_Recorder.fKeptRecords() length == 0", function () {
        expect( someKeptRecordsAfterClear.length).toBe( 0);
    });
    ...
    it("Has aCommon_Recorder_SetRecordingPointer_02_afterFirstRecord == -1", function () {
    ...
    it("Has aCommon_Recorder_SetRecordingPointer_02_afterSecondRecord == -1", function () {
