 ...
 * reuse_svce.js
 *
 * Created @author Antonio Carrasco Valero 201601270113
 *
 *
 ***************************************************************************
...
angular.module("reuseSvceTypes").factory("ReuseSvce", [
    "ReuseSvceType",
    "IdentifierSvce",
    "RecorderSvce",
    function( theSS_ReuseSvceType,
              theSS_IdentifierSvce,
              theSS_RecorderSvce){

        var aService = new theSS_ReuseSvceType.ReuseSvce_Constructor(
            "Reuse_Service",
            theSS_IdentifierSvce,
            theSS_RecorderSvce
        );
