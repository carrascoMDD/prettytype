/*
 * common_type-dumpingpolicy_triggerkinds_none-behavioral-test.js
 *
 * Created @author Antonio Carrasco Valero 201610281546
 *
 *
 ***************************************************************************
...
describe("prettytype Common dumpingpolicy filterkinds none behavioral tests", function () {
    ...
    it("Has aNumCollectedLogsAfter3 == 3", function () {
        expect( aNumCollectedLogsAfter3).toBe( 0);
    });
    ...
    it("Has aCommon_Recorder_SetRecordingPointer_LastDumpedRecord_afterThirdRecord == undefined", function () {
